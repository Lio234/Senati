...
DELIMITER $$
CREATE PROCEDURE sp_mostrar_departamentos()
BEGIN
...
DELIMITER $$
CREATE PROCEDURE sp_mostrar_provincias()
BEGIN
    SELECT 
        p.id_provincia, 
        p.provincia, 
...
DELIMITER $$
CREATE PROCEDURE sp_mostrar_distritos()
BEGIN
    SELECT 
        d.id_distrito, 
        d.distrito, 
...
DELIMITER $$
CREATE PROCEDURE sp_mostrar_areas_trabajo()
BEGIN
...
DELIMITER $$
CREATE PROCEDURE sp_mostrar_marcas()
BEGIN
...
DELIMITER $$
CREATE PROCEDURE sp_mostrar_producto_proveedor()
BEGIN
    SELECT 
...
DELIMITER $$
CREATE PROCEDURE sp_mostrar_envios()
BEGIN
    SELECT 
        e.id_envio, 
        e.fecha_envio, 
