...
<?php
$ruta = "../..";
$titulo = "Aplicación de Ventas - Filtrar Departamentos";
...
<body>
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-filter"></i> Filtrar Departamentos</h1>
            <hr />
        </header>
            ...
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="col-md-5">
                        ...
                        <form id="frm_filtrar_dep" name="frm_filtrar_dep" method="post">
    ...
    <script>
        $(document).ready(function () {
            $("#btn_nuevo").click(function () {
                $("#frm_filtrar_dep")[0].reset(); // Limpia el formulario
    ...
    <div class="modal fade" id="modalNoResultados" tabindex="-1" aria-labelledby="modalNoResultadosLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    No se encontraron departamentos que coincidan con su búsqueda.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                </div>
