...
<?php
$ruta = "../..";
$titulo = "Aplicación de Ventas - Filtrar Categorias";
...
<body>
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-filter"></i> Filtrar Categorias</h1>
            <hr />
        </header>
            ...
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="col-md-5">
                        ...
                        <form id="frm_filtrar_cat" name="frm_filtrar_cat" method="post">
    ...
    <script>
        $(document).ready(function () {
            $("#btn_nuevo").click(function () {
                $("#frm_filtrar_cat")[0].reset(); // Limpia el formulario
