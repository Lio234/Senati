...
<?php
$ruta = "../..";
$titulo = "Aplicación de Ventas - Filtrar Nombres";
...
<body>
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-filter"></i> Filtrar nombres</h1>
            <hr />
        </header>
            ...
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="col-md-5">
                        ...
                        <form id="frm_filtrar_clien" name="frm_filtrar_clien" method="post">
    ...
    <script>
        $(document).ready(function () {
            $("#btn_nuevo").click(function () {
                $("#frm_filtrar_clien")[0].reset(); // Limpia el formulario
