...
<?php
$ruta = "../..";
$titulo = "Aplicacion de ventas - Consultar categoria";
            ...
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="card col-md-6">
                        <div class="card-body">
                            <form id="frm_consultar_cat" name="frm_consultar_cat" method="post">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label for="txt_codcat" class="form-label">Codigo</label>
                                        <input type="text" class="form-control" id="txt_codcat" name="txt_codcat"
